...
export class JNI {
  ...
  findClass: NativeFunction<NativePointer, [handle: NativePointer, className: NativePointer]>
  getMethodID: NativeFunction<NativePointer, [handle: NativePointer, klass: NativePointer, methodName: NativePointer, signature: NativePointer]>

  constructor() {
    const jniEnvPtr = Java.vm.getEnv().handle.readPointer()
    this.handle = jniEnvPtr
    this.findClass = new NativeFunction(getJNIFunctionAddress(this.handle, 'FindClass'), 'pointer', ['pointer', 'pointer'])
    this.getMethodID = new NativeFunction(getJNIFunctionAddress(this.handle, 'GetMethodID'), 'pointer', ['pointer', 'pointer', 'pointer', 'pointer'])
  }

  getArtMethod(className: string, methodName: string, signature: string): NativePointer {
    ...
    const methodIdPtr = this.getMethodID(this.handle, klassPtr, methodNamePtr, signaturePtr)
 ...
 */
function getJNIFunctionAddress(jnienv_addr: NativePointer, func_name: string): NativePointer {
